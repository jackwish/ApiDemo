...
JNIEXPORT jboolean JNICALL Java_com_young_apkdemo_LinkerActivity_ns_load_lib(JNIEnv *env, jobject obj, jstring lib)
{
...
JNIEXPORT jstring JNICALL Java_com_young_apkdemo_LinkerActivity_ns_scan_arm_path(JNIEnv *env, jobject obj)
{
